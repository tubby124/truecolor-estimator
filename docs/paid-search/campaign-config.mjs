...
export const paidSearchConfig = {
  ...
  // Owner-approved CA$650 total-spend limit: keep Core serving for roughly CA$50
  // after the CA$600 promotional target, then pause automatically.
  maximumPilotCad: 650,
  targetQualifyingSpendCad: 600,
  spendControls: {
    scope: "EXACT_ACCOUNT_TOTAL",
    warningCad: 450,
    protectivePauseCad: 650,
    absoluteCapCad: 650,
  ...
  externalGates: [
    ...
    { code: "DATES_AND_HARD_STOP", status: "VERIFIED", required: "46-day pilot dates 2026-08-03 to 2026-09-17, 5-minute scheduler heartbeat, CA$450 warning, and CA$650 total-spend pause", evidence: "On 2026-08-28 the owner authorized Core to keep serving for roughly CA$50 after the CA$600 promo target. Railway's five-minute primary schedule was proven with consecutive production heartbeats; the runtime threshold and authorized cap are both CA$650. Daily budgets, CPC ceilings, networks, match types, and geo remain unchanged." },
