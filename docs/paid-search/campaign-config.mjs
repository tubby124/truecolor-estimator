...
export const paidSearchConfig = {
  ...
  externalGates: [
    ...
    { code: "OFFLINE_UPLOADER_MIGRATION", status: "BLOCKED", required: "Move revenue delivery off the deprecated Google Ads API UploadClickConversion path and prove the supported production uploader" },
