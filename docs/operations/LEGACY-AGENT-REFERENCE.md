# Historical agent reference — superseded September 5, 2026

Historical architecture context only. Read root AGENTS.md and CURRENT-STATE.md first. Old local @ imports, blanket SEO changes, dated prices/status and approval language do not control current work. Verify against code, CSVs and latest evidence.
