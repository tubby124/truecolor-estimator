...
| Merchant commerce / commerce task | Sep 7: **Owner-authorized resume and one Save completed.** Reopened Canada preserved pickup later and Verified example URL; pickup remains In progress and inventory Data validation in progress. Merchant sources last updated Sep 7 00:00 CST: primary 18 updated / 0 new; local 18 updated / 18 matched; no file issues. Source-filtered replacement list has 18 offers: 16 Under review / 2 business-card offers Not approved for Image not processed and Unverified inventory. Both card images fetched successfully at 19:10 Regina and matched approved bytes. | Google says no image action needed and it will retry within three days; wait for inventory verification. Save/navigation and persisted settings are verified, without an explicit new review receipt, approval or serving evidence. Preserve 25 legacy offers, local `out_of_stock`, both feeds' `multi-week` pickup SLA and Ads exclusions. |
