...
| Social / Instagram pilot | PR #32 merged; prior task reports deployed staff review. Fresh Sep 6 00:58 UTC readiness: approval schema present, 12 drafts, zero active accounts, Meta configuration absent, publishing off. [Setup and recovery](../social/SETUP-RUNBOOK.md). | Complete dedicated publisher setup and provider identity/scopes readback; local voice preview is not content approval or live delivery. |
