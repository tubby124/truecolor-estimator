...
| Social / integration coordinator | Sep6: after final September calendar approval, exact five-source SQL transaction applied successfully. Readback:14newtables,14RLS,0browserreadgrants, verified operator and tax-policy marker. Existing eight approvals preserved. [Integration evidence](../social/INTEGRATION-20260906.md). | Business feature configuration deployment is in progress; new month upload readiness must be read back. Exact-scope scheduler/Telegram monitor code passes local tests/review but is not installed. Preserve original Sunday pilot until all six reconciled; latest22:30UTC fourposted/twofuture. New month task owns final48destination saves/approvals; integration owns SQL/config/VPS. |
