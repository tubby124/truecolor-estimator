...
| Merchant commerce / commerce task | Sep 7: **Paused by owner; no further work for now.** Prior repair handoff reports the explicit immediate-out-of-stock/later-pickup wording and single-store selector deployed. Continuation verified 43 total products on Overview, but setup content stayed blank/loading. No Save/resubmission or new approval receipt. | Resume only on owner request. Google review/serving status and current source-specific 18/18 processing remain unconfirmed in this continuation. Preserve 25 legacy products, pickup-later truth and Ads exclusions. |
