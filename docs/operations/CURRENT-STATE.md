...
| Analytics / payment audit task | Sep 9: two post-cutover website Clover orders lacked all three GA IDs. Bounded supported-tag priming, strict same-client session fallback and legacy replay safety stop in release verification. [Continuity release](../analytics/CONTINUITY-RELEASE-20260909.md); [provider/reporting readiness](../analytics/ATTRIBUTION-READINESS-20260909.md). Fresh Ads read: all three campaigns paused; primary upload actions only, no custom-goal override. GA4 owner UI config verified; Admin API remains disabled. | Complete reviewed CI/merge/deployment and public/payment-page smoke. Then require a genuine new context-bearing website order/payment and processed GA4 session attribution. Durable retries and genuine PPC/Meta destination proof remain open. No historical replay, invented IDs or campaign activation. |
