...
- Private Drive: dated ZIP (61,101,414 bytes), CSV index and start-here file uploaded to the existing Instagram work area's new Reusable Asset Library folder. Metadata readback confirmed the ZIP's size/parent and owner-only visibility. Local ZIP integrity check passed; this is not a completed remote archive restore drill.
