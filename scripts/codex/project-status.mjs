...
const docs = ['AGENTS.md', 'docs/TRUE-COLOR-INDEX.md', ...['CURRENT-STATE.md', 'BUSINESS-CONTEXT.md', 'HISTORY-PRODUCTS.md', 'HISTORY-OPERATIONS.md', 'HISTORY-GROWTH.md', 'SEO-STANDARD.md', 'SOURCE-REGISTRY.md', 'CLOUD-PLAYBOOK.md', 'MIGRATION-RECEIPT.md'].map(p => `docs/operations/${p}`)];
const errors = [];
