              ...
              <div>
                ...
                {lowContrast && !isPlaceholder ? (
                  <p role="status" className="mt-2 flex gap-2 text-xs leading-relaxed text-[#b42318]">
                    ...
                    <span>
                      <strong>Transport Canada requires a colour that contrasts with the hull.</strong>{" "}
                      {selectedColor?.label} on a {hull?.label.toLowerCase()} hull does not, so this
                      combination would not meet the display rule under the Canada Shipping Act.
                      Pick a lighter or darker vinyl and the number will read from another boat.
                    </span>
                  </p>
                ) : (
                  <p className="mt-2 text-xs text-gray-500">
