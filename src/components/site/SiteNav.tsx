...
const INDUSTRY_LINKS = [
  ...
  { label: "Commercial Signs", href: "/commercial-signs-saskatoon" },
  { label: "Community Printing", href: "/community-printing-saskatoon" },
  ...
  { label: "Education", href: "/education-signs-saskatoon" },
  { label: "For-Lease Signs", href: "/for-lease-signs-saskatoon" },
  { label: "Healthcare", href: "/healthcare-signs-saskatoon" },
  { label: "Dental Office Signs", href: "/dental-office-signs-saskatoon" },
  { label: "Retail Stores", href: "/retail-signs-saskatoon" },
  { label: "Restaurants", href: "/restaurant-signs-saskatoon" },
  { label: "Schools & Sports", href: "/school-signs-saskatoon" },
  { label: "Gym & Fitness", href: "/gym-fitness-signs-saskatoon" },
  { label: "Events & Weddings", href: "/banner-printing-saskatoon" },
  { label: "Agribusiness Signs", href: "/agribusiness-signs-saskatchewan" },
  { label: "Vinyl Lettering", href: "/vinyl-lettering-saskatoon" },
  { label: "Custom Magnets", href: "/vehicle-magnets-saskatoon" },
  { label: "Salon Signs", href: "/salon-signs-saskatoon" },
  { label: "Election Signs", href: "/election-signs" },
