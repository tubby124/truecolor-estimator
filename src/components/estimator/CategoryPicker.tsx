...
const CATEGORIES: CategoryOption[] = [
  ...
  { id: "MAGNET", label: "Vehicle Magnet", sublabel: "30mil · Custom", icon: "🧲", group: "wide_format" },
  { id: "DECAL", label: "Decal / Sticker", sublabel: "Vinyl · Cut or Print", icon: "⬡", group: "wide_format" },
