  ...
  return `<!-- FOOTER -->
        <tr>
          <td style="background:#1c1712;border-radius:0 0 12px 12px;padding:24px 32px;text-align:center;">
            ...
            <p style="margin:0${extra ? " 0 8px" : ""};font-size:11px;color:#7a6560;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
              ${gstNumber} &middot; All amounts in CAD
            </p>${extraLine}
          </td>
        </tr>`;
}
