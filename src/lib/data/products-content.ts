...
export const PRODUCTS: Record<string, ProductContent> = {
  "coroplast-signs": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-coroplast-remax-openhouse.webp",
      "/images/gallery/gallery-coroplast-71st-storage.webp",
      "/images/gallery/gallery-coroplast-parking-signs.webp",
      "/images/gallery/gallery-coroplast-retail-zaks-pricing.webp",
      "/images/gallery/gallery-coroplast-bjm-graduation.webp",
  ...
  "vinyl-banners": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-banner-karuna-vitamin.webp",
      "/images/gallery/gallery-shop-roland-ag-banner.webp",
    ],
    defaultSides: 1,
    sideOptions: false,
    sizePresets: [
  ...
  "business-cards": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-business-cards-bd-deep-cleaning.webp",
    ],
    defaultSides: 2,
    sideOptions: true,
    sizePresets: [
  ...
  "flyers": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-flyers-boxed-marketing.webp",
      "/images/gallery/gallery-flyer-axis-health.webp",
      "/images/gallery/gallery-flyer-pulse-strategies.webp",
    ],
    defaultSides: 2,
    sideOptions: true,
    sizePresets: [
  ...
  "acp-signs": {
    ...
    description:
      "ACP (aluminum composite panel) is the rigid option for long-term business signage, address plaques, site identification boards, and retail directories. The material consists of two thin aluminum face sheets bonded to a polyethylene core, producing a panel that's rigid but surprisingly lightweight — far easier to handle than solid aluminum plate. True Color produces the full-colour graphic on our Roland TrueVIS VG2 eco-solvent printer/cutter and finishes it onto the ACP panel. Unlike coroplast, ACP stays flat and rigid in demanding sign applications. Standard sizes run from 12×18\" up to 4×8 ft. Mounting holes are drilled on request for screw-and-standoff installation; adhesive backing is available for glass or finished walls. Gloss laminate is standard; matte finish is available on request. ACP is the right call for long-term signage on a building exterior, at a gated entrance, or in a lobby. Printed and cut in-house at 216 33rd St W, Saskatoon — no outsourcing. Paid same-day rush may be available for +$40 flat on eligible weekday orders placed before 10 AM; call (306) 954-8688 to confirm capacity before ordering.",
    fromPrice: "$39",
    category: "RIGID",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "ACP is intended for long-term sign applications. Expected service life depends on the graphic, laminate, installation, exposure, and maintenance.",
      },
      {
    ...
    materialInfo: {
      ...
      bullets: [
        ...
        "Full-colour printed graphic finished onto rigid ACP",
  ...
  "window-decals": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-window-decal-pact-agriculture.webp",
      "/images/gallery/gallery-window-decal-skull-car.webp",
    ],
    defaultSides: 1,
    sideOptions: false,
    sizePresets: [
  ...
  "window-perf": {
    ...
    galleryImages: [
      ...
      "/images/products/product/window-perf-gym-storefront-800x600.webp",
  ...
  "vinyl-lettering": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-vinyl-lettering-cowry-kitchen.webp",
      "/images/gallery/gallery-vinyl-lettering-mags.webp",
  ...
  "boat-registration-numbers": {
    ...
    galleryImages: [
      "/images/industries/boat-registration-numbers/boat-registration-number-decal-aluminum-bow-1200x800.webp",
      "/images/industries/boat-registration-numbers/boat-registration-number-decal-transfer-tape-1200x1200.webp",
      "/images/industries/boat-registration-numbers/boat-registration-decal-application-squeegee-1200x800.webp",
      "/images/industries/boat-registration-numbers/boat-registration-numbers-outfitter-fleet-1200x800.webp",
      "/images/industries/boat-registration-numbers/boat-name-decal-transom-red-1200x800.webp",
  ...
  "retractable-banners": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-retractable-two-men-truck.webp",
      "/images/gallery/gallery-retractable-shammi-realtor.webp",
      "/images/gallery/gallery-retractable-borna-realtor.webp",
      "/images/gallery/gallery-retractable-lilians-hair.webp",
      "/images/gallery/gallery-retractable-wfg-insurance.webp",
    ],
    defaultSides: 1,
    sideOptions: false,
    sizePresets: [
    ...
    faqs: [
      {
        ...
        a: "25 stickers minimum. Setup and cutting time make smaller runs uneconomical. A 4×4\" sticker runs $1.20 each at 50 units, $1.00 at 100, and around $0.33 each at 1000. Carts under $25 add a small-order setup fee to reach the $25 order minimum.",
      },
      {
  ...
  "product-labels": {
    ...
    description:
      "Custom product labels printed in Saskatoon on Arlon DPF 510 adhesive vinyl — 3.2 mil, the same film behind our window decals — then die-cut and gloss laminated. 25 labels start at $25. Roland TrueVIS VG2 eco-solvent inks resist scuffing, moisture, and fading, so a label still reads cleanly after a season on a shelf or in a cooler. Built for Saskatchewan food producers, ag suppliers, breweries, and makers who need short runs without a minimum of 1,000. Price drops sharply with volume — the same label runs a fraction of the per-unit cost at 500 than at 25. Supply a PDF or high-res PNG at 150+ DPI; in-house design is $40 flat with a same-day proof. Pickup at 216 33rd St W, Saskatoon, or same-day rush for +$40 flat when ordered before 10 AM.",
    fromPrice: "$25",
    category: "STICKER",
    material_code: "ARLPMF7008",
  ...
  "roll-labels": {
    ...
    description:
      "Bulk label runs printed in Saskatoon on Arlon DPF 510 adhesive vinyl — 3.2 mil, gloss laminated, die-cut to size. 25 labels start at $25, and the per-label cost drops steeply as the run grows, which is what makes a 500 or 1,000 run worth doing in one go. Roland TrueVIS VG2 eco-solvent inks are waterproof and UV-resistant, so the same artwork works across product, freezer, and jar applications. Labels are supplied die-cut on sheets as standard. If you need them wound on a roll for an applicator machine, call (306) 954-8688 before ordering so we can confirm core size, wind direction, and whether your run suits roll fulfilment. Supply a PDF or high-res PNG at 150+ DPI; in-house design is $40 flat. Pickup at 216 33rd St W, Saskatoon.",
    fromPrice: "$25",
    category: "STICKER",
    material_code: "ARLPMF7008",
  ...
  "postcards": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-postcards-oxenfree-crafts.webp",
  ...
  "rack-cards": {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes — in-house design is $40 flat, same-day proof. Bring your logo, key message, and contact details and we'll build the layout.",
      },
      {
  ...
  "photo-posters": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-large-format-realtor-poster.webp",
    ],
    defaultSides: 1,
    sideOptions: false,
    sizePresets: [
  ...
  "magnet-calendars": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-magnet-calendar-lyndell-concrete.webp",
      "/images/gallery/gallery-magnet-calendar-shuttle.webp",
    ],
    defaultSides: 1,
    sideOptions: false,
    sizePresets: [
