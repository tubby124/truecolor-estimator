...
export const PRODUCTS: Record<string, ProductContent> = {
  "coroplast-signs": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-coroplast-parking-signs.jpg",
      "/images/gallery/gallery-coroplast-retail-zaks-pricing.jpg",
      "/images/gallery/gallery-coroplast-bjm-graduation.jpg",
  ...
  "vinyl-banners": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-shop-roland-ag-banner.jpg",
    ],
    defaultSides: 1,
    sideOptions: false,
    sizePresets: [
  ...
  "flyers": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-flyer-axis-health.jpg",
  ...
  "window-decals": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-window-decal-pact-agriculture.jpg",
      "/images/gallery/gallery-window-decal-skull-car.jpg",
    ],
    defaultSides: 1,
    sideOptions: false,
    sizePresets: [
  ...
  "vinyl-lettering": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-vinyl-lettering-skbk-trailer.jpg",
    ],
    defaultSides: 1,
    sideOptions: false,
    sizePresets: [
  ...
  "retractable-banners": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-retractable-lilians-hair.jpg",
      "/images/gallery/gallery-retractable-wfg-insurance.jpg",
    ],
    defaultSides: 1,
    sideOptions: false,
    sizePresets: [
  ...
  "postcards": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-postcards-oxenfree-crafts.jpg",
    ],
    defaultSides: 2,
    sideOptions: false,
    sizePresets: [
  ...
  "photo-posters": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-large-format-realtor-poster.jpg",
    ],
    defaultSides: 1,
    sideOptions: false,
    sizePresets: [
  ...
  "magnet-calendars": {
    ...
    galleryImages: [
      ...
      "/images/gallery/gallery-magnet-calendar-lyndell-concrete.jpg",
      "/images/gallery/gallery-magnet-calendar-shuttle.jpg",
    ],
    defaultSides: 1,
    sideOptions: false,
    sizePresets: [
