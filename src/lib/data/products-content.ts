...
export const PRODUCTS: Record<string, ProductContent> = {
  ...
  "window-perf": {
    ...
    heroImage: "/images/products/product/perf-vinyl-storefront-exterior-800x600.webp",
    galleryImages: [
  ...
  "vinyl-lettering": {
    ...
    material_code: "ARLPMF7008",
    heroImage: "/images/products/product/vinyl-lettering-shop-window-800x600.webp",
    galleryImages: [
  ...
  "stickers": {
    ...
    category: "STICKER",
    material_code: "ARLPMF7008",
    heroImage: "/images/products/product/sticker-diecut-truecolor-logo-800x600.webp",
    galleryImages: [
  ...
  "postcards": {
    ...
    category: "POSTCARD",
    material_code: "PLACEHOLDER_14PT",
    heroImage: "/images/products/product/postcard-realtor-justlisted-800x600.webp",
    galleryImages: [
  ...
  "brochures": {
    ...
    heroImage: "/images/products/product/brochure-trifold-open-800x600.webp",
    galleryImages: [
  ...
  "photo-posters": {
    ...
    heroImage: "/images/products/product/poster-framed-gallery-wall-800x600.webp",
    galleryImages: [
  ...
  "magnet-calendars": {
    ...
    category: "MAGNET",
    material_code: "MAG302437550M",
    heroImage: "/images/products/product/magnet-calendar-fridge-800x600.webp",
    galleryImages: [
