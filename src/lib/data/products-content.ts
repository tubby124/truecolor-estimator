    ...
    customTextFields: [
      {
        ...
        placeholder: "SK 9612467",
        required: true,
        maxLength: 20,
        pattern: "^[A-Za-z]{2}\\s?\\d{4,8}$",
        patternHint: "Two letters then the digits, e.g. SK 9612467 — copy it exactly off your Pleasure Craft Licence.",
        help: "Saskatchewan licences start with SK. We cut exactly what you type here. Want the boat's name too? Add this pair, then add the $18 boat name decal as a second item.",
        preview: true,
        appliesToMaterial: [
