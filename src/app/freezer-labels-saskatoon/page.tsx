    ...
    <IndustryPage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Raw pet food brands (Evolution Raw and others), butchers and meat processors, ice cream and frozen dessert makers, frozen meal manufacturers, cold storage operators, and anyone running a freezer line at a Saskatoon food business. Order sizes range from $30 minimum (small format) up to 500–5,000 piece runs for production lines.",
        },
        {
