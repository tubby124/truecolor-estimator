      ...
      faqs={[
        {
          ...
          a: "Freezer labels at True Color use a four-tier sqft-based rate: $5.50/sqft for 0–12 sqft (Tier 1), $5.00/sqft for 12–32 sqft (Tier 2), $4.30/sqft for 32–100 sqft (Tier 3), and $3.20/sqft for 100+ sqft (Tier 4). $25 order-total minimum applies at checkout. As a real-world anchor: a 10×2\" label at quantity 500 runs about $300, and a 10×3.5\" label at quantity 500 runs about $390.",
        },
        {
