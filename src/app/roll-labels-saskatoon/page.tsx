    ...
    <IndustryPage
      ...
      descriptionNode={
        <>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Quote turnaround is one business day once you send specs (label width × height, qty, core ID, substrate, finish, unwind direction). Production runs <strong>5–7 business days</strong> after artwork approval for standard roll work. Same-day rush is generally not available on roll labels because of slitting and rewinding setup — small reruns (under 1,000) can sometimes be expedited for the standard <strong>+$40 flat</strong> rush fee, but call <a href="tel:13069548688" className="underline">(306) 954-8688</a> first to confirm capacity. If you don&apos;t have print-ready artwork, our in-house designer builds production-ready files for <strong>$40 flat</strong> with a same-day proof.
          </p>
          <p className="text-gray-600 leading-relaxed">
            Roll labels are best for high-volume packagers running inline equipment. If you only need a few hundred labels for a one-off product launch, our <Link href="/sticker-printing-saskatoon" className="text-[#16C2F3] hover:underline font-medium">flat stickers</Link> (cut to shape, supplied loose or on backing sheets) are usually faster and cheaper — check that page first. Roll work makes sense once you&apos;re running enough volume that hand-applying becomes the bottleneck. Common Saskatchewan customers: craft breweries pushing cans and bottles through a canning line, cannabis producers needing CRA-compliant child-resistant labels at scale, hot-sauce makers, kombucha brewers, and packaged-food producers serving regional grocery. To start a quote, use our <Link href="/quote" className="text-[#16C2F3] hover:underline font-medium">quote request form</Link>, or compare options against <Link href="/window-decals-saskatoon" className="text-[#16C2F3] hover:underline font-medium">window decals</Link> and <Link href="/vinyl-lettering-saskatoon" className="text-[#16C2F3] hover:underline font-medium">vinyl lettering</Link> for other packaging and signage needs.
          </p>
        </>
      }
      products={[
      ...
      whyPoints={[
        ...
        "In-house designer builds print-ready label files for $40 flat with same-day proof",
