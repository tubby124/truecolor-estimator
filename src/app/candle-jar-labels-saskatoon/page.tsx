    ...
    <IndustryPage
      ...
      descriptionNode={
        <>
          ...
          <p className="text-gray-700 leading-relaxed">
            Need design help? Our in-house designer lays out wraparounds, builds round die-cut artwork, and cleans up your label files for <strong>$40 flat</strong> with a same-day proof. For larger sticker runs or contour-cut graphics, see our <a href="/sticker-printing-saskatoon" className="text-[#16C2F3] underline hover:no-underline">sticker printing</a> page. For storefront window displays at your booth or shop, check our <a href="/window-decals-saskatoon" className="text-[#16C2F3] underline hover:no-underline">window decals</a>. Pickup at 216 33rd St W, Saskatoon — call <a href="tel:+13069548688" className="text-[#16C2F3] underline hover:no-underline">(306) 954-8688</a> or email info@true-color.ca.
          </p>
        </>
      }
      products={[
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Yes. Our in-house designer lays out candle and jar labels for $40 flat — that covers initial layout, the wraparound or die-cut template, and two rounds of revisions. Same-day proof if you submit your brief before 10 AM. Bring a description, a reference photo, your logo file, or even a phone photo of a competitor's label you like.",
        },
        {
          q: "Where do I pick up labels in Saskatoon?",
          a: "True Color Display Printing — 216 33rd St W, Saskatoon SK S7L 0V1. Call (306) 954-8688 or email info@true-color.ca. Everything prints in-house, no outsourcing. Local pickup is free; we can also ship across Saskatchewan. Design is $40 flat and same-day rush is +$40 flat.",
        },
      ]}
    />
  );
