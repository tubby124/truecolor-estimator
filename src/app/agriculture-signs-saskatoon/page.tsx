...
const designDirections = [
  ...
  },
  {
    ...
    subtitle: "30mil magnetic vinyl from $24/sqft \u00b7 removable, no paint damage.",
    aspect: "4/3" as const,
    maxCols: 2 as const,
    items: [
      {
    ...
    <IndustryPage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Yes \u2014 our in-house Photoshop designer handles layouts from a rough sketch, description, or brand guide for $40 flat. Logo creation or vectorization is $40. Most proofs come back same day. Design and print happen in the same building \u2014 no files moving between vendors.",
        },
      ]}
    />
  );
