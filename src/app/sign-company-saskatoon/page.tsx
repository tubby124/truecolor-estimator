...
export const metadata: Metadata = {
  title: "Sign Company Saskatoon | Coroplast, ACP & Vinyl Signs | True Color",
  description:
    "Saskatoon's in-house sign company. Coroplast yard signs from $8/sqft, ACP aluminum signs from $13/sqft, vinyl lettering, vehicle magnets, window decals. Same-day rush. Local pickup 216 33rd St W.",
