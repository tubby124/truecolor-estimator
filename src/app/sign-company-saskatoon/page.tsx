  ...
  return (
    <IndustryPage
      ...
      descriptionNode={
        <>
          ...
          <p className="text-gray-600 text-lg leading-relaxed mb-6">
            ...
            handles layouts for $40 flat with a same-day proof — no separate design vendor needed.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            No jobs leave the building. No broker markup. The in-house designer ($40 flat,
      ...
      whyPoints={[
        ...
        "In-house designer handles layouts from scratch — $40 flat, proof same day",
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Yes — our in-house designer handles sign layouts for a flat fee of $40. That covers the initial proof and two revision rounds. If you have existing artwork, we'll review your file for free and flag any issues before printing. Logo creation is included at the same $40. Multi-product sign packages and full brand identity work are quoted individually.",
        },
        {
        ...
        },
        {
          ...
          a: "ACP signs at True Color are $13/sqft single-sided. Common sizes: 12×18\" = $19.50 raw (single-panel carts top up to the $25 order-total minimum), 24×36\" = $78, 4×4 ft = $176, 4×8 ft = $320. ACP is the material of choice for permanent storefront signs, office building directories, and any application where rigid, weather-resistant signage is required.",
        },
        {
