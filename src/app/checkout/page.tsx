...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main id="main-content" className="max-w-5xl mx-auto px-6 py-14">
        <h1 className="text-3xl font-bold text-[#1c1712] mb-5">Checkout</h1>

        {/* Trust strip */}
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mb-10 text-sm text-gray-500">
          <span className="flex items-center gap-2">
            <svg className="w-4 h-4 text-yellow-400 fill-yellow-400 shrink-0" viewBox="0 0 24 24">
              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
            </svg>
            {RATING_VALUE} stars · {REVIEW_COUNT} reviews
          </span>
          <span className="flex items-center gap-2">
