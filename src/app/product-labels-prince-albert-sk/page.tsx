...
export const metadata: Metadata = {
  title: { absolute: "Product Labels Prince Albert SK | From $25 | True Color" },
  description:
    "Retail product labels for Prince Albert artisan food, fisheries, craft brands. From $25. Printed in Saskatoon, courier to Prince Albert.",
  alternates: { canonical: "/product-labels-prince-albert-sk" },
  openGraph: {
    title: "Product Labels Prince Albert SK | True Color Display Printing",
    description:
      "Full-colour retail product labels. Gloss, matte, or soft-touch. From $25. Printed in Saskatoon, couriered to Prince Albert.",
...
export default function ProductLabelsPrinceAlbertPage() {
  return (
    <IndustryPage
      ...
      subtitle="Retail product labels for PA artisan food, fisheries, craft brands. From $25."
      ...
      descriptionNode={
        <>
          <p className="text-gray-600 text-lg leading-relaxed">
            ...
            from <strong>$25 for 25 labels</strong> — a 3×4&quot; label is $67 for 100 and $165 for 500. Full material spec
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "25 labels start at $25. A 3×4\" label is $67 for 100, $167.50 for 250, and $165 for 500 — about $0.33 each at that run. Configure your exact size and quantity on the product page to see the price before ordering.",
        },
        {
