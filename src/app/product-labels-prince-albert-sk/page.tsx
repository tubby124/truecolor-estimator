    ...
    <IndustryPage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Sqft-tiered: $5.50/sqft (T1, 0–12 sqft), $5.00/sqft (T2), $4.30/sqft (T3), $3.20/sqft (T4 at 100+ sqft). Minimum $30. A 3×4\" label at quantity 500 runs about $300.",
        },
        {
        ...
        },
        {
          ...
          a: "Yes — $30 minimum charge covers small format jobs. No five-digit MOQ. Start with 100–250 labels for a co-op grocery test, scale up later.",
        },
        {
