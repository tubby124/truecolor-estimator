  ...
  return (
    <IndustryPage
      ...
      descriptionNode={
        <>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            ...
            18×24&quot; at $24 each (single signs top up to the $25 order-total minimum at checkout). Need brochures for a community program or outreach campaign?
      ...
      products={[
        ...
        { name: "Coroplast Signs", from: "from $25", slug: "coroplast-signs" },
      ...
      whyPoints={[
        ...
        "Parking and wayfinding sorted — coroplast signs 18×24\" at $24 each ($25 order-total min at checkout)",
