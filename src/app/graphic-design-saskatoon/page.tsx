    ...
    <IndustryPage
      ...
      descriptionNode={
        <>
          ...
          <p className="text-gray-600 text-lg leading-relaxed mb-6">
            ...
            and resizing, a full original design from scratch, and logo recreation or
            vectorization from a low-resolution JPG or PNG are all $40 flat — one price. We build print-ready files for
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Yes. Full original design from scratch, logo recreation, and vectorization from a low-resolution file are all $40 flat — one price regardless of scope. You'll receive a print-ready file plus source files you can use anywhere.",
        },
        {
          q: "Can you do logo design in Saskatoon and print it on signs or cards?",
          a: "Yes — True Color handles logo design in Saskatoon and prints the finished artwork in the same shop. Basic artwork setup and full original design are both $40 flat, and we can apply the logo to business cards from $45, banners from $66, coroplast signs from $25, or ACP aluminum signs from $39.",
        },
        {
          q: "Can you make my logo print-ready from a JPG or PNG?",
          a: "Yes. Logo recreation, vectorization from a low-resolution JPG or PNG, and basic resizing or colour setup are all $40 flat. We prepare print-ready PDFs for signs, banners, flyers, cards, wall graphics, vehicle magnets, and window decals.",
        },
        {
