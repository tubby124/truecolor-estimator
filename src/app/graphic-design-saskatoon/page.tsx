    ...
    <IndustryPage
      ...
      descriptionNode={
        <>
          ...
          <p className="text-gray-600 text-lg leading-relaxed mb-6">
            ...
            or vectorization from a low-resolution JPG or PNG is $75. We build print-ready files for
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Yes. Full original design from scratch is $50 for a standard logo/layout concept, and logo recreation or vectorization from a low-resolution file is $75. You'll receive a print-ready file plus source files you can use anywhere.",
        },
        {
        ...
        },
        {
          ...
          a: "Yes. Logo recreation or vectorization from a low-resolution JPG or PNG is $75, and basic resizing or colour setup is $35. We prepare print-ready PDFs for signs, banners, flyers, cards, wall graphics, vehicle magnets, and window decals.",
        },
        {
