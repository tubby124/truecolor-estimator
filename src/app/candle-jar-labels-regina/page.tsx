...
export default function CandleJarLabelsReginaPage() {
  return (
    <IndustryPage
      ...
      description={
        "Custom heat-resistant candle labels and mason-jar labels printed in Saskatoon, shipped to Regina 260 km south. From $25 on matte BOPP vinyl with heat-resistant adhesive — bonds to warm glass after hot-wax pour, no bubbling, no curling near the flame, no yellowing over a 40+ hour burn. Built for Regina home-fragrance brands, soy and beeswax candle makers, artisan jam and preserve canners, and farmers market vendors. In-house design ($40 flat), 1–3 business day turnaround. Ground courier adds 1–2 days."
      }
      descriptionNode={
        <>
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            In-house Photoshop designer builds label layouts for $40 flat with same-day
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "25 labels start at $25. A 2.5×3.5\" jar label is $55 for 100 and $122.50 for 250; a 3×4\" is $67 for 100 and $167.50 for 250. A full 2.5×8\" mason jar wraparound is $1.11 each at any quantity, because a label that size prices by area rather than by the small-label quantity ladder. Regina courier is customer's cost.",
        },
        {
