...
export default function NonProfitSignsSaskatoonPage() {
  return (
    <IndustryPage
      ...
      products={[
        { name: "Coroplast Yard Signs", from: "from $8/sqft", slug: "coroplast-signs" },
      ...
      whyPoints={[
        "50 lawn signs for a fundraiser campaign — coroplast 18×24\" $24 each (single signs top up to $25 cart min), 8% off at 5+",
