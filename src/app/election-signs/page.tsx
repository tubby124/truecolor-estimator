...
export const metadata: Metadata = {
  ...
  description:
    "Coroplast election yard signs in Saskatoon and Saskatchewan. Volume pricing: 23% off at 25+ signs. H-stakes $2.50. Double-sided available.",
...
export default function ElectionSignsPage() {
  return (
    <IndustryPage
      ...
      description="Coroplast election yard signs start at $8/sqft at True Color Display Printing in Saskatoon, Saskatchewan — a standard 24×36 inch campaign sign is $48 single-sided. Campaign timing is everything, and we print election signs in-house on our Roland UV printer with 1–3 business day turnaround. Volume pricing kicks in automatically with no corporate account or broker markup: 5+ signs save 8% ($7.36/sqft), 10+ signs save 17% ($6.64/sqft), and 25+ signs save 23% ($6.16/sqft). Double-sided coroplast is available for corner lots and high-visibility intersections. H-stakes are $2.50 each for installation on lawns and boulevards. The standard election sign size across Saskatchewan is 24×36 inches — visible from the road, fits standard H-stakes, and is large enough for a candidate's name, party colours, and riding information. For smaller residential lawns, 18×24 inch signs at $24 each work well. For high-traffic intersections and building lot corners, 4×8 ft coroplast signs at $232 are impossible to miss. Vehicle magnets for campaign vehicles start at $24/sqft on 30mil stock — rated for highway speeds and removable without damaging paint. Business cards for campaign volunteers and door-knocking teams start at 250 for $45. Flyers for policy platforms and riding-specific messaging are available from $45 for 100 copies on 80lb gloss. Our in-house designer handles layouts from your party logo, candidate photo, and campaign colours for $40 flat with same-day proof. Same-day rush printing is available for +$40 flat on orders placed before 10 AM — call (306) 954-8688 to confirm capacity. When the writ drops, we can have your first batch of signs ready within 24 hours. True Color ships election signs across Saskatchewan — Saskatoon, Regina, Prince Albert, Moose Jaw, North Battleford, Yorkton, Swift Current, and rural ridings. Local Saskatoon pickup at 216 33rd St W."
      descriptionNode={
        <>
          <p className="text-gray-600 text-lg leading-relaxed">
            ...
            automatically — no corporate account, no broker markup. A $25 order-total minimum applies at checkout.
          </p>
          <p className="text-gray-600 leading-relaxed">
            Our Roland UV printer produces consistent, vibrant colour across every sign in your run.
            Volume discounts apply automatically: 8% off at 5+ signs, 17% off at 10+ signs,
            23% off at 25+ signs ($6.16/sqft). Double-sided coroplast is available for corner lots and high-visibility
            intersections. H-stakes are $2.50 each.{" "}
            ...
            for door-knocking teams start at 250 for $45. All materials are weather-resistant
      ...
      whyPoints={[
        "Volume discount at 25+ signs — 23% off ($6.16/sqft for standard 24×36\")",
        "Double-sided coroplast for corner placement — maximum visibility at intersections",
        "H-stakes at $2.50 each — bundled pricing available with any coroplast order",
        "Consistent Roland UV colour across 10, 100, or 500 signs — your brand stays sharp",
        "Vehicle magnets from $24/sqft — campaign vehicle branding without permanent commitment",
        "Same-day rush +$40 flat — when the writ drops, signs ready within 24 hours",
        "In-house designer builds layouts from your party logo and candidate photo — $40 flat",
      ...
      faqs={[
        {
          ...
          a: "Volume discounts apply automatically by quantity: 5+ signs saves 8%, 10+ signs saves 17%, and 25+ signs saves 23% ($6.16/sqft). It's per order, based on number of signs.",
        },
        {
        ...
        },
        {
          ...
          a: "Yes — 80lb gloss flyers for policy platforms start at 100 for $45 (2-sided, 8.5×11 inch). Business cards for campaign volunteers start at 250 for $45 on 14pt gloss. For larger runs, 1000 flyers are $185 and 1000 business cards are $110. Our in-house designer handles the layout from your party branding for $40 flat with same-day proof.",
        },
      ]}
    />
  );
