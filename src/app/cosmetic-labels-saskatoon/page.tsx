    ...
    <IndustryPage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "We print exactly what you supply in your artwork. Health Canada requires an INCI ingredient list, net quantity in metric units, manufacturer name and address, lot code, and PAO symbol — these are your responsibility to include. If your design needs help laying out the required text at legal minimum sizes, our in-house designer is $35 flat for standard layouts with a same-day proof. We do not certify compliance — that is between you and Health Canada — but we will print what you send.",
        },
        {
