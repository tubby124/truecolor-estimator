  ...
  return (
    <IndustryPage
      ...
      whyPoints={[
        ...
        "18×24\" job site ID sign — $30 ($30 minimum applies), ready in 1–3 business days from your logo or sketch",
