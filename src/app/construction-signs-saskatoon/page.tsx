  ...
  return (
    <IndustryPage
      ...
      descriptionNode={
        <>
          ...
          <p className="text-gray-600 leading-relaxed mb-8">
            ...
            (18×24&quot;, $24 each — $25 order-total minimum at checkout) with the company name and permit number, a pair of 30mil{" "}
            ...
            and directional coroplast signs (18×24&quot; $24 each, $25 order-total minimum at checkout) for subdivision roads. For fencing and
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            winters. Standard sizes: 18×24&quot; ($24, $25 order-total minimum at checkout) or 24×36&quot; ($48). Bring your requirements
      ...
      whyPoints={[
        ...
        "18×24\" job site ID sign — $24 raw, $25 checkout floor for a single-sign cart, ready in 1–3 business days from your logo or sketch",
      ...
      faqs={[
        {
          ...
          a: "At True Color Display Printing (216 33rd St W, Saskatoon, SK), coroplast job site signs are from $8/sqft. An 18×24\" sign (standard job site ID size) is $24 raw, and a single-sign cart tops up to the $25 order-total minimum at checkout. A 24×36\" safety or permit sign is $48. A 4×8 ft development or show home sign is $232 + GST. All are UV-resistant and waterproof for Saskatchewan outdoor conditions.",
        },
        {
        ...
        },
        {
          ...
          a: "Yes — safety signs including 'Hard Hat Area', 'No Unauthorized Entry', 'Safety Glasses Required', and custom site ID signs with contractor name and permit number. Printed on 4mm coroplast at $8/sqft, UV-resistant and waterproof. Standard sizes: 18×24\" ($24 raw; $25 checkout floor for a single-sign cart) or 24×36\" ($48). Bring your requirements and we'll lay out a compliant sign in-house.",
        },
        {
          q: "Can you print hoarding banners and construction fence banners in Saskatoon?",
          a: "Yes — full-colour vinyl banners at $8.25/sqft (13oz scrim) are popular for construction fencing and hoarding panels in Saskatoon. A 4×20 ft hoarding banner is $600 + GST and turns your site perimeter into advertising for the project. Hemming and grommets included. Standard turnaround 1–3 business days — call (306) 954-8688 for urgent site deadlines.",
        },
        {
          q: "Do you print home builder signs and development project signs in Saskatoon?",
          a: "Yes — new home builders and developers in Saskatoon order coroplast development signs (4×8 ft, $232 + GST), show home directional signs (18×24\", $24 raw; $25 checkout floor for a single-sign cart), and job site identification signs. We print in-house and have orders ready in 1–3 business days. For subdivision launches and show home openings, same-day rush is +$40 flat — call (306) 954-8688.",
        },
        {
