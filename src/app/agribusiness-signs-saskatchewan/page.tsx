    ...
    <IndustryPage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Yes — our in-house Photoshop designer creates print-ready layouts from your brand guide, a logo file, or a rough sketch. Design is $40 flat with same-day proof — minor edits, standard layouts, full design from scratch, and logo creation or vectorization are all the same price. All artwork files are yours to keep.",
        },
      ]}
    />
  );
