...
export const metadata: Metadata = {
  title: { absolute: "Product Labels Saskatoon | From $25 | True Color" },
  description:
    "Custom product and food labels printed in Saskatoon. 25 from $25, 500 for $165 on 3 mil vinyl. Gloss or matte, 1–3 business day turnaround.",
  alternates: { canonical: "/product-labels-saskatoon" },
  openGraph: {
    title: "Product Labels Saskatoon | From $25 | True Color",
    description:
      "Custom product and food labels printed in Saskatoon. 25 from $25, 500 for $165 on 3 mil vinyl. Pickup at 216 33rd St W.",
...
export default function ProductLabelsSaskatoonPage() {
  return (
    <IndustryPage
      ...
      subtitle="Product and food labels printed in Saskatoon. 25 from $25. Waterproof vinyl, in-house."
      ...
      whyPoints={[
        "25 labels from $25 — a 3×4\" is $67 for 100 and $165 for 500",
        "3mil ARLPMF7008 white vinyl — cold-storage, freezer, and outdoor-product safe",
        "Roland TrueVIS VG2 eco-solvent ink, gloss laminated — won't fade after six months on a sunlit shelf",
        ...
        "In-house designer at $40 flat for ingredients lists, nutrition blocks, barcodes, EN/FR",
      ]}
      faqs={[
        {
          q: "How much do product labels cost in Saskatoon?",
          a: "25 labels start at $25. A 3×4\" label — a common product size — is $67 for 100, $167.50 for 250, and $165 for 500, which works out to about $0.33 each at the 500 run. Configure your exact size and quantity on the product page and the price appears before you order, with no quote form.",
        },
        {
          q: "What material do you use for product and food labels?",
          a: "3 mil ARLPMF7008 pressure-sensitive white vinyl, printed full colour on our Roland TrueVIS VG2 eco-solvent printer/cutter. It's built for cold storage, freezer use, condensation from refrigerated product, and outdoor handling at farmers' markets. Available in gloss (most common for jars, bottles, and food brands) or matte (premium feel, common for craft beverage and supplements). Both finishes cost the same — 25 labels from $25.",
        },
        {
