...
export const metadata: Metadata = {
  title: { absolute: "Logo Vectorization Saskatoon | $40 Flat | True Color" },
  description:
    "Logo vectorization in Saskatoon, $40 flat. Raster JPG/PNG to AI, EPS, SVG, PDF. Hand-drawn in Adobe Illustrator. Free with $250+ large-format orders.",
  alternates: { canonical: "/logo-vectorization-saskatoon" },
  openGraph: {
    title: "Logo Vectorization Saskatoon | Raster to Vector $40 Flat | True Color",
    description:
      "Hand-drawn raster-to-vector logo conversion in Saskatoon. AI, EPS, SVG, PDF formats. $40 flat. Free with $250+ sign or vehicle decal orders.",
    ...
    <IndustryPage
      ...
      descriptionNode={
        <>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Turnaround is 1–2 business days standard after you send the source file. Same-day rush is +$40 flat if you order before 10 AM — useful when you&apos;re approving a vehicle wrap or a trade-show banner on a deadline. You own the vector files forever — no licensing fees, no ransom, no subscriptions. We send the AI, EPS, SVG, and PDF, and you can hand them to any printer, embroiderer, or web designer you want. Minor logo edits after vectorization (colour swap, tagline update) run on the in-house designer rate of $40 flat with same-day proof.
          </p>
      ...
      whyPoints={[
        "Logo vectorization $40 flat — one price, simple marks and complex logos alike",
        "Gradients, photo elements, and multi-component logos included at the same $40",
      ...
      faqs={[
        {
          ...
          a: "$40 flat, whatever the logo. Simple 1–3 colour marks and complex logos with gradients, photo elements, or multiple components are the same price — we stopped charging a complexity premium because in practice almost every job landed at the same number anyway. If you're already placing a $250+ large-format order (vehicle decals, banners, ACP signs), vectorization is included free.",
        },
        {
          q: "What file formats do I get?",
          a: "Every $40 vectorization order is delivered as AI (Adobe Illustrator), EPS, SVG, and PDF — the four vector formats any commercial printer, embroiderer, or web designer will accept. You own all four files forever, no licensing fees, no subscriptions.",
        },
        {
          q: "Why do I need a vector logo for printing?",
          a: "Raster files (JPG, PNG) are pixels — they pixelate when scaled up. A logo that looks fine on a $45 business card will fuzz out on a $232 4×8 ft coroplast sign or a $400+ vehicle decal. Vector files stay razor sharp at any size. Vectorize once for $40, use the file on every print job from now on.",
        },
        {
          q: "Do you use auto-tracing or hand-redraw the logo?",
          a: "Hand-redraw — that's the True Color difference. Auto-tracing (Illustrator's Image Trace button) leaves jagged edges, broken type, and weird artifacts on anything past a basic shape. Our in-house designer rebuilds the logo from scratch in Adobe Illustrator, including real fonts and Pantone/CMYK colour matching. Worth the $40 versus a $5 fiverr auto-trace.",
        },
        {
          q: "How fast is vectorization turnaround?",
          a: "1–2 business days standard after you send the source file. Same-day rush is +$40 flat if you order before 10 AM — handy when you're approving a vehicle wrap, trade-show banner, or embroidery job on a deadline. Minor edits after the vector is approved (colour swap, tagline update) run on the in-house designer rate of $40 flat with same-day proof.",
        },
        {
          q: "Is vectorization really free with a sign or decal order?",
          a: "Yes — if your large-format order is $250 or more in the same session (vehicle magnets at $24/sqft, banners at $8.25/sqft, ACP at $13/sqft, coroplast at $8/sqft, window decals at $11/sqft), we bundle the vectorization at no extra charge. Below $250 the standard $40 flat rate applies. Most full vehicle decal jobs and trade-show banner orders qualify.",
        },
        {
          q: "What source file should I send you?",
          a: "Anything you have — JPG screenshot of an old business card, faded image from a five-year-old website, phone photo of a printed sign, low-res social avatar, even a fax-quality copy. The lower the resolution, the more redraw work — but the price is still $40. Send what you've got and we'll quote it same day.",
        },
        {
          q: "Where do I get this done in Saskatoon?",
          a: "True Color Display Printing at 216 33rd St W, Saskatoon SK. Call (306) 954-8688 or email info@true-color.ca with your source file. We reply same day to confirm ($40 flat, or free with a $250+ large-format order). Pickup or digital delivery — your call.",
        },
      ]}
    />
  );
