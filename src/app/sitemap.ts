...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/gallery`, lastModified: new Date("2026-03-17"), changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/coroplast-signs-saskatoon`, lastModified: new Date("2026-04-12"), changeFrequency: "monthly", priority: 0.95 },
    ...
    { url: `${BASE_URL}/sign-company-saskatoon`, lastModified: new Date("2026-04-12"), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${BASE_URL}/agribusiness-signs-saskatchewan`, lastModified: new Date("2026-03-13"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/agriculture-signs-saskatoon`, lastModified: new Date("2026-03-13"), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${BASE_URL}/vinyl-lettering-saskatoon`, lastModified: new Date("2026-04-12"), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/for-lease-signs-saskatoon`, lastModified: new Date("2026-05-14"), changeFrequency: "monthly", priority: 0.85 },
