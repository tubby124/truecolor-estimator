...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/wall-graphics-saskatoon`, lastModified: new Date("2026-08-11"), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/sticker-printing-saskatoon`, lastModified: new Date("2026-08-16"), changeFrequency: "monthly", priority: 0.85 },
