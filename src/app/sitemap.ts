...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    // ── Core pages ───────────────────────────────────────────────────────────
    { url: `${BASE_URL}/`, lastModified: new Date("2026-08-06"), changeFrequency: "weekly", priority: 1.0 },
    { url: `${BASE_URL}/products`, lastModified: new Date("2026-06-22"), changeFrequency: "monthly", priority: 0.6 },
    { url: `${BASE_URL}/gallery`, lastModified: new Date("2026-08-06"), changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/banner-printing-saskatoon`, lastModified: new Date("2026-08-11"), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${BASE_URL}/graphic-design-saskatoon`, lastModified: new Date("2026-08-28"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/printing-prices-saskatoon`, lastModified: new Date("2026-08-06"), changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE_URL}/sign-company-saskatoon`, lastModified: new Date("2026-06-05"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/wall-graphics-saskatoon`, lastModified: new Date("2026-08-28"), changeFrequency: "monthly", priority: 0.8 },

    // ── Print product SEO pages — sprint (2026-03-03) ────────────────────────
    { url: `${BASE_URL}/flyer-printing-saskatoon`, lastModified: new Date("2026-08-23"), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${BASE_URL}/sticker-printing-saskatoon`, lastModified: new Date("2026-08-28"), changeFrequency: "monthly", priority: 0.85 },
    ...
    { url: `${BASE_URL}/coroplast-signs-regina`, lastModified: new Date("2026-08-11"), changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/signs-prince-albert-sk`, lastModified: new Date("2026-08-11"), changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/printing-lloydminster-sk`, lastModified: new Date("2026-08-11"), changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/signs-moose-jaw-sk`, lastModified: new Date("2026-08-11"), changeFrequency: "monthly", priority: 0.75 },
