...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/gallery`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/services`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/coroplast-signs-saskatoon`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.95 },
    ...
    { url: `${BASE_URL}/sign-company-saskatoon`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/wall-graphics-saskatoon`, lastModified: new Date("2026-04-27"), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/real-estate-signs-saskatoon`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE_URL}/construction-signs-saskatoon`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE_URL}/agribusiness-signs-saskatchewan`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/agriculture-signs-saskatoon`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/restaurant-signs-saskatoon`, lastModified: new Date("2026-01-08"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/election-signs`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.85 },
    ...
    { url: `${BASE_URL}/sticker-printing-saskatoon`, lastModified: new Date("2026-05-09"), changeFrequency: "monthly", priority: 0.85 },
    ...
    { url: `${BASE_URL}/foamboard-printing-saskatoon`, lastModified: new Date("2026-04-12"), changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE_URL}/vinyl-lettering-saskatoon`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/car-dealership-signs-saskatoon`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/non-profit-signs-saskatoon`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/hotel-signs-saskatoon`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/property-management-signs-saskatoon`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/for-lease-signs-saskatoon`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.85 },

    // ── Label & service SEO pages — Wave 2026-05-14 product expansion ───────
    { url: `${BASE_URL}/labels-saskatoon`, lastModified: new Date("2026-05-14"), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${BASE_URL}/image-upscale-saskatoon`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.75 },
    ...
    { url: `${BASE_URL}/logo-vectorization-regina`, lastModified: new Date("2026-05-14"), changeFrequency: "monthly", priority: 0.65 },
    { url: `${BASE_URL}/logo-vectorization-moose-jaw-sk`, lastModified: new Date("2026-05-14"), changeFrequency: "monthly", priority: 0.65 },
    ...
    { url: `${BASE_URL}/printing-lloydminster-sk`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/signs-moose-jaw-sk`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/printing-swift-current-sk`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.75 },

    // ── SK city pages — Sprint C (2026-03-05) ─────────────────────────────────
    { url: `${BASE_URL}/signs-north-battleford-sk`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/signs-yorkton-sk`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/printing-estevan-sk`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/printing-weyburn-sk`, lastModified: new Date("2026-05-20"), changeFrequency: "monthly", priority: 0.75 },
