...
const descriptionNode = (
  <>
    ...
    <p className="text-gray-600 leading-relaxed mb-10">
      ...
      for the trailer, in-house design is $35 flat with a same-day proof. Standard turnaround is
    ...
    <IndustryPage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Standard turnaround is 1–3 business days from the time we have your licence number — there is no artwork for you to supply. Same-day rush is +$40 flat if you order before 10 AM. Pickup is at 216 33rd St W, Saskatoon. In-house design, if you want a custom layout, is $35 flat with a same-day proof.",
        },
      ]}
    />
  );
