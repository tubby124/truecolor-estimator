            ...
            <div className="text-white">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3">
                ...
                >
                  ...
                  <span className="tc-phone">(306) 954-8688</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#f4efe9] px-6 py-6" aria-label="Trust signals">
        <div className="max-w-6xl mx-auto flex flex-wrap items-center gap-x-8 gap-y-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[#1c1712] font-bold text-sm">{RATING_VALUE}</span>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <a href="tel:+13069548688" className="text-[#1c1712] font-semibold text-sm hover:text-[#16C2F3] transition-colors"><span className="tc-phone">(306) 954-8688</span></a>
