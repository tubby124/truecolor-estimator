...
const MAPS_EMBED =
  "https://www.openstreetmap.org/export/embed.html?bbox=-106.6850%2C52.1270%2C-106.6550%2C52.1390&layer=mapnik&marker=52.1325%2C-106.6700";
...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-[#1c1712]">
      ...
      {/* ── HERO: Store Photo + Address ── */}
      <section className="w-full px-6 pt-14 pb-10 md:pt-20 md:pb-14 max-w-6xl mx-auto">
      ...
      {/* ── INFO CARDS ── */}
      <section className="px-6 pb-14 max-w-6xl mx-auto" aria-label="Contact information">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5">
            ...
            <p className="text-white font-semibold text-sm mb-1">Monday – Friday</p>
            <p className="text-gray-300 text-sm">9 AM – 5 PM</p>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5">
            ...
            <a href="tel:+13069548688" className="block text-white font-semibold text-sm hover:text-[#16C2F3] transition-colors mb-1">
              (306) 954-8688
            </a>
            <a href="mailto:info@true-color.ca" className="block text-gray-300 text-sm hover:text-[#16C2F3] transition-colors">
              info@true-color.ca
            </a>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5">
            ...
            <address className="not-italic">
              <p className="text-white font-semibold text-sm mb-1">216 33rd St W</p>
              <p className="text-gray-300 text-sm">Saskatoon, SK S7L 0V5</p>
            </address>
            <a
              href={MAPS_URL}
              target="_blank"
      ...
      {/* ── TRUST BAR ── */}
      <section className="px-6 pb-10 max-w-6xl mx-auto" aria-label="Trust signals">
        <div className="flex flex-wrap items-center gap-x-8 gap-y-4 border-t border-white/8 pt-8">
          {/* Google rating */}
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-400 text-sm">on Google · 29 reviews</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-300 text-sm">Serving Saskatoon since 2019</span>
          </div>
          <div className="h-4 w-px bg-white/10 hidden sm:block" aria-hidden="true" />
          <div className="flex items-center gap-2">
            <svg className="w-4 h-4 text-[#16C2F3] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
            ...
            <span className="text-gray-300 text-sm">In-house Roland UV — no outsourcing</span>
          </div>
          <div className="h-4 w-px bg-white/10 hidden sm:block" aria-hidden="true" />
          <div className="flex items-center gap-2">
            <svg className="w-4 h-4 text-[#16C2F3] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
            ...
            <span className="text-gray-300 text-sm">Local pickup · 216 33rd St W</span>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 pb-16 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="rounded-2xl overflow-hidden border border-white/10 shadow-xl" style={{ height: "480px" }}>
            <iframe
              src={MAPS_EMBED}
              title="True Color Display Printing — 216 33rd St W, Saskatoon SK"
              width="100%"
              height="100%"
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-7">
            <h2 className="text-white font-bold text-xl mb-1">Send a Message</h2>
      ...
      <section className="px-6 pb-16 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div>
            <h2 className="text-white font-bold text-2xl mb-4">What to Expect In Store</h2>
            ...
            <p className="text-gray-300 text-base leading-relaxed">
              We print <Link href="/coroplast-signs-saskatoon" className="text-[#16C2F3] hover:underline">coroplast signs from $30</Link>,{" "}
              <Link href="/banner-printing-saskatoon" className="text-[#16C2F3] hover:underline">vinyl banners from $66</Link>,{" "}
              <Link href="/business-cards-saskatoon" className="text-[#16C2F3] hover:underline">business cards from $45</Link>,{" "}
          ...
          <div>
            <h2 className="text-white font-bold text-2xl mb-4">Same-Day Rush Available</h2>
            <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link
                  ...
                  className="border border-white/20 text-gray-300 text-sm font-semibold px-5 py-2.5 rounded-md hover:border-white hover:text-white transition-colors"
                >
                  Rush Details →
                </Link>
              </div>
      ...
      <section className="px-6 pb-20 max-w-4xl mx-auto">
        <h2 className="text-white font-bold text-2xl mb-8">Frequently Asked Questions</h2>
