...
export default function SignsNorthBattlefordPage() {
  return (
    <IndustryPage
      ...
      relatedCities={CITY_HUB_PAGES.filter((c) => c.slug !== "signs-north-battleford-sk")}
      ...
      descriptionNode={
        <>
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            from $24/sqft stick securely to steel service truck doors and equipment
            ...
            An 18×24&quot; ACP panel is $39; 24×36&quot; is $78. $25 order-total minimum applies at checkout. Vinyl banners from $8.25/sqft for
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Yes — ACP aluminum signs from $13/sqft. An 18×24\" panel is $39, 24×36\" is $78. $25 order-total minimum applies at checkout. ACP is the right choice for permanent outdoor business signage — survives 10+ years without fading or warping in harsh Saskatchewan winters. We print on Roland UV and ship flat to North Battleford.",
        },
        {
