...
const designDirections = [
  {
    ...
    subtitle:
      "100 for $100 · 500 for $220 · 1000 for $330 — die-cut vinyl, Roland eco-solvent print, waterproof",
    aspect: "4/3" as const,
    maxCols: 3 as const,
    items: [
      {
        ...
        label: "Logo Die-Cut",
        caption: "100 for $100 — brand identity stickers",
      },
      {
        ...
        caption: "500 for $220 — labels for jars, bottles, boxes",
      },
      {
        ...
        caption: "1000 for $330 — promo giveaways + branding",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        caption: "Most popular — 100 for $100",
      },
      {
        src: "/images/products/product/sticker-custom-sheet-800x600.webp",
...
export default function StickerPrintingSaskatoonPage() {
  return (
    <IndustryPage
      ...
      description="Custom die-cut vinyl stickers for Saskatoon businesses — product labels, packaging branding, promo giveaways, and vehicle decals. Printed full-colour on our in-house Roland TrueVIS VG2 eco-solvent printer/cutter on durable waterproof vinyl. Standard size is 4x4 inch die-cut. Custom sizes available. Pricing: 100 stickers = $100, 500 = $220, 1000 = $330. Same-day rush +$40 flat, order before 10 AM. In-house designer $40 flat with same-day proof. Standard turnaround 1–3 business days after artwork approval. Local pickup at 216 33rd St W, Saskatoon."
      descriptionNode={
        <>
          <p className="text-gray-600 text-lg leading-relaxed">
            ...
            on our in-house Roland TrueVIS VG2 eco-solvent printer/cutter — waterproof, scratch-resistant, and colour-accurate
            whether they end up on a jar, a truck panel, or a laptop. Standard pricing:{" "}
            <strong>100 stickers = $100</strong>, <strong>500 = $220</strong>,{" "}
            <strong>1000 = $330</strong>. Default size is 4×4&quot; die-cut. Custom shapes and
            sizes are available — quote on request.
          </p>
          <p className="text-gray-600 leading-relaxed">
            The Roland eco-solvent process produces vivid, scratch-resistant colour that holds up
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            <strong>$40 flat</strong> with a same-day digital proof. You approve the shape
          ...
          <p className="text-gray-600 leading-relaxed">
            <strong>What does &quot;custom stickers near me&quot; mean at True Color in Saskatoon?</strong> It means die-cut vinyl stickers printed in-house at 216 33rd St W on a Roland eco-solvent press — 100 stickers for $100, 500 for $220, 1000 for $330 on the default 4×4&quot; size. Every order is true die-cut: contour-cut around your custom shape (not just kiss-cut on a sheet), printed on durable waterproof vinyl, with no edge cracking through Saskatchewan winters. Looking for <strong>custom labels near me</strong> for jars, candles, cosmetics, growler tags, or freezer-rated packaging across Saskatchewan? Same Roland eco-solvent process, same pricing tier — the die-cut path is built around your label outline and proofed same-day before any vinyl gets cut. Same-day rush is +$40 flat (order before 10 AM); standard turnaround is 1–3 business days. In-house designer $40 flat with same-day proof.
          </p>
          <p className="text-gray-600 leading-relaxed">
            ...
            from your vector file (or our designer creates one for $40 flat). We don&apos;t
            outsource — files cut here, on the same Roland that printed them, so the
            ...
            same pricing — 100 product labels for $100 is the most common run for a
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            size: a 4×4&quot; default run is <strong>100 for $100</strong>,{" "}
            <strong>500 for $220</strong>, and <strong>1000 for $330</strong>; small 2×2&quot;
            ...
            <strong>$40 flat</strong> with a same-day proof.
          </p>
          <DesignDirectionGrid sections={designDirections} />
        </>
      }
      products={[
        { name: "Stickers (Die-Cut)", from: "100 for $100", slug: "stickers" },
      ...
      whyPoints={[
        "Colours hold up in SK winters, on water bottles, and on vehicle panels — Roland eco-solvent ink won't crack or fade",
        "Die-cut to any shape — circles, logo outlines, ovals — not locked to rectangles or kiss-cut sheets",
        "100 stickers from $100 | 500 from $220 | 1000 from $330 — pricing that actually makes sense for a product run",
        ...
        "In-house designer $40 flat — bring a logo or a rough idea, we build the die-cut path",
      ]}
      productOffer={{
        name: "Custom Die-Cut Vinyl Stickers",
        description:
          "Full-colour die-cut vinyl stickers printed in-house on a Roland eco-solvent press in Saskatoon. Waterproof, scratch-resistant, custom shapes and sizes. Default size 4x4 inch.",
        lowPrice: 25,
        highPrice: 400,
        offerCount: 4,
      }}
      faqs={[
        {
          ...
          a: "True Color Display Printing at 216 33rd St W, Saskatoon — full-colour custom stickers from 100 for $100, 500 for $220, 1000 for $330 on waterproof die-cut vinyl. Every order is printed in-house on our Roland eco-solvent press, so the colour you see in the proof is the colour you pick up. Same-day rush available for +$40 flat when ordered before 10 AM.",
        },
        {
          q: "Where can I get custom labels near me in Saskatchewan?",
          a: "We print custom die-cut labels in Saskatoon for Saskatchewan small businesses — candle jars, cosmetics, food packaging, growlers, freezer products, beauty bottles. Standard run is 100 labels for $100 or 500 for $220 on waterproof eco-solvent printed vinyl. Bring the container dimensions and our in-house designer ($40 flat) builds the cut line around the finished piece — same-day proof, 1–3 business day production.",
        },
        {
          q: "Where can I get die cut stickers near me in Saskatoon?",
          a: "True Color at 216 33rd St W, Saskatoon prints true die-cut stickers — cut along your logo or custom shape on the same Roland that printed them, no outsourcing. Standard pricing is 100 for $100, 500 for $220, 1000 for $330 with the 4×4\" default size. Custom shapes and sizes quoted on request, same-day rush available for +$40 flat.",
        },
        {
          q: "Do you make custom die cut stickers near me for laptops, water bottles, and vehicles?",
          a: "Yes — die-cut vinyl stickers from $100 / 100 hold up on laptops, water bottles, helmets, vehicle panels, and outdoor signage. Our Roland eco-solvent ink is scratch-resistant and waterproof, no edge cracking through Saskatchewan winters. For larger vehicle branding, see our vehicle magnets from $24/sqft and window decals from $11/sqft — all printed in the same Saskatoon shop.",
        },
        {
          q: "Do you make custom die cut labels near me for product packaging in Saskatchewan?",
          a: "Yes — die-cut labels for jars, bottles, growler tags, freezer products, and cosmetic packaging are one of our most-ordered sticker types. Pricing matches standard stickers: 100 labels for $100, 500 for $220, 1000 for $330. Bring your label dimensions and our in-house designer ($40 flat) prepares the file with a same-day proof — pickup at 216 33rd St W in 1–3 business days.",
        },
        {
          q: "What's the difference between die-cut and kiss-cut stickers?",
          a: "Die-cut stickers are cut all the way through both the vinyl and the backing — each sticker comes out as a separate piece in your custom shape. Kiss-cut stickers cut only the vinyl, leaving the backing intact so multiple stickers stay on one sheet. True Color prints true die-cut as standard — every sticker contour-cut around your shape. Pricing is the same either way: 100 for $100, 500 for $220.",
        },
        {
          q: "Are sticker sheets cheaper than individual die-cut stickers?",
          a: "Sticker sheets can be cheaper when several small designs fit inside one finished sheet, but individual die-cut stickers are better for handouts, product packaging, and retail inserts. We price by finished size and quantity: 2×2\" starts at 25 for $25, while the common 4×4\" run is 100 for $100 or 500 for $220. If your sheet needs multiple cut paths, our designer can set it up for $40 flat with a same-day proof.",
        },
        {
          q: "How much do custom die-cut stickers cost in Saskatoon?",
          a: "Standard die-cut vinyl stickers are 100 for $100, 500 for $220, and 1000 for $330 on the default 4×4\" size. Smaller 2×2\" run $65 / 100 and larger 8×8\" run $400 / 100. The 4×4\" per-unit drops from $1.00 at 100 to $0.44 at 500 and $0.33 at 1,000. Full price grid lives on the instant calculator at /products/stickers.",
        },
        {
          q: "Are your stickers waterproof and rated for Saskatchewan winters?",
          a: "Yes — Roland eco-solvent ink on durable vinyl is waterproof, scratch-resistant, and tested through Saskatchewan freeze-thaw cycles without cracking, fading, or peeling at die-cut edges. Suitable for outdoor signage, vehicle panels, water bottles, dishwashers (top-rack), and freezer packaging. Add a matte or gloss laminate on request for extra abrasion resistance.",
        },
        {
          q: "What's the minimum sticker order at True Color?",
          a: "25 stickers is our minimum — $25 for 25× 2×2\" or 25× 4×4\" die-cut. Per-unit drops with volume: a 4×4\" is $1.00 each at 100, $0.44 at 500, and $0.33 at 1,000. A $25 order-total minimum applies at checkout on the very smallest carts.",
        },
        {
          q: "Can you print stickers in custom shapes — circles, ovals, logo outlines?",
          a: "Yes — die-cut means contour-cut to any shape: circles, ovals, rounded rectangles, custom logo outlines, growler tags, candle-jar wraps, any vector silhouette. If you have an Illustrator or PDF file with the cut path, we use it as-is. No file? Our in-house designer prepares the die-cut path for $40 flat with a same-day proof.",
        },
        {
          q: "Can I put multiple designs on one custom sticker sheet?",
          a: "Yes — you can combine multiple small stickers on one sheet if each design has enough spacing for clean cutting. The job still follows the sticker size grid, so a 4×4\" finished sheet starts at 25 for $25, 100 for $100, and 500 for $220. Send the artwork as a PDF or AI file with cut paths, or have our Saskatoon designer build the sheet for $40 flat.",
        },
        {
        ...
        },
        {
          ...
          a: "We accept PDF, AI, EPS (vector preferred), or PNG/JPG at 300 dpi minimum at the print size. Vector files let us pull a clean die-cut path directly from your shape. If your file is a low-res phone photo or Word doc, our in-house designer rebuilds it print-ready for $40 flat with a same-day proof — no surprise charges.",
        },
        {
          q: "Do complex sticker shapes cost more than circles or rectangles?",
          a: "Most logo outlines, circles, ovals, and rounded rectangles use the normal die-cut price grid: 100 4×4\" stickers for $100, 500 for $220, or 1000 for $330. Very detailed edges, interior cutouts, or many designs on one sheet may need a quick file-prep review before we quote. If the cut path needs rebuilding, design setup is $40 flat with a same-day proof.",
        },
      ]}
    />
  );
