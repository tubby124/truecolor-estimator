    ...
    <IndustryPage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Yes — die-cut labels for jars, bottles, growler tags, freezer products, and cosmetic packaging are one of our most-ordered sticker types. Pricing matches standard stickers: 100 labels for $160, 250 for $325, 500 for $475. Bring your label dimensions and our in-house designer ($40 flat) prepares the file with a same-day proof — pickup at 216 33rd St W in 1–3 business days.",
        },
        {
        ...
        },
        {
          ...
          a: "Sticker sheets can be cheaper when several small designs fit inside one finished sheet, but individual die-cut stickers are better for handouts, product packaging, and retail inserts. We price by finished size and quantity: 2×2\" starts at 25 for $25, while the common 4×4\" run is 100 for $160 or 250 for $325. If your sheet needs multiple cut paths, our designer can set it up for $40 flat with a same-day proof.",
        },
        {
        ...
        },
        {
          ...
          a: "Yes — you can combine multiple small stickers on one sheet if each design has enough spacing for clean cutting. The job still follows the sticker size grid, so a 4×4\" finished sheet starts at 25 for $60, 100 for $160, and 250 for $325. Send the artwork as a PDF or AI file with cut paths, or have our Saskatoon designer build the sheet for $40 flat.",
        },
        {
