    ...
    <IndustryPage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Yes — our in-house designer builds signage with high-contrast text, readable fonts, and appropriate sizing for patients with visual impairments. Bring your content requirements and we'll handle the layout for $40 flat with same-day proof.",
        },
        {
