  ...
  return (
    <IndustryPage
      ...
      whyPoints={[
        ...
        "Vehicle magnets from $45 — industrial and potash sector fleet branding, removable and reusable",
