    ...
    <IndustryPage
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Most clinics order 250 cards per practitioner (from $40) to start a referral program. If you have 3 practitioners and run a 6-month campaign, order 500 per person ($65 two-sided). We keep your files on record for fast reorders. Batch orders for the whole clinic get one proof round and one invoice.",
        },
        {
