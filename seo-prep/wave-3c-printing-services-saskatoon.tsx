...
export default function PrintingServicesSaskatoonPage() {
  return (
    <IndustryPage
      ...
      description="Full printing services in Saskatoon for businesses, contractors, real estate, restaurants, healthcare, agriculture, retail, schools, and non-profits. Wide-format (banners, coroplast, ACP, foamboard, retractable, window vinyl, vehicle graphics, wall graphics) plus commercial print (business cards, flyers, brochures, postcards, stickers, posters, booklets) under one roof. In-house Roland UV printer + Konica Minolta digital press. Same-day rush +$40 flat. In-house designer $40 flat with same-day proof. Standard turnaround 1–3 business days. Local pickup at 216 33rd St W."
      descriptionNode={
        <>
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            <strong>$40 flat</strong> if you need artwork built or fixed.
          </p>
        </>
      }
      products={[
      ...
      whyPoints={[
        ...
        "In-house designer $40 flat with same-day digital proof — bring any rough idea, we build the print-ready file",
      ...
      faqs={[
        ...
        },
        {
          ...
          a: "Both. In-house designer $40 flat with same-day digital proof. Bring a logo, rough sketch, Word doc, or even a verbal description — we build the print-ready file. Common asks: business card layout, flyer design from a service menu, banner copy from event details, vehicle magnet layout. Logo recreation from a low-res JPG is the same $40 flat — vectorization is not a premium tier.",
        },
        {
        ...
        },
        {
          ...
          a: "PDF at 150 dpi minimum (300 dpi for wide-format banners) is preferred. We also accept Adobe Illustrator (.ai), Photoshop (.psd), EPS, and high-res PNG/JPG. Bleed of 1/8\" on all sides for full-bleed designs. No file? In-house designer $40 flat builds the print-ready file from a rough idea.",
        },
      ]}
    />
  );
